...
#Wir haben hier die Funktion von numpy genommen, weil der Aufbau unseres Gauss nicht zur gewünschten  Lösung führte und wir den Fehler leider nicht gefunden haben.
y = np.linalg.solve(Matrix_A, Vector_b)
...
print('y = ' + str(np.polyval(y.transpose()[0], 6)))
print('Wenn man den Wert 7 einsetzt: ')
#x7 =  polynom(7, y.transpose())
print('y = '+ str(np.polyval(y.transpose()[0], 7)) )